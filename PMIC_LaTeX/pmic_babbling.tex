...
\scriptsize Credit:\thinspace{\itshape Peggy und Marco Lachmann-Anke, Pixabay}
\end{figure}
\end{columns}
\end{frame}
...
\scriptsize Credit:\thinspace{\itshape Gerhard, Pixabay}
\end{figure}
\end{frame}
...
\begin{figure}
\includegraphics[scale=0.34]{image_dl/question.png} \\
\scriptsize Credit:\thinspace{\itshape Pete Linforth, Pixabay}
\end{figure}
\end{frame}
